...
@switch($shortcode->style)
    @case('style-2')
        ...
        <section class="section-box">
            <div class="banner-hero hero-2" @if($shortcode->background_image) style="background: url({{ RvMedia::getImageUrl($shortcode->background_image) }}) no-repeat top center;" @endif>
                                ...
                                @foreach($featureCompanies as $featureCompany)
                                    <div class="swiper-slide">
                                        <a href="{{ $featureCompany->url }}">
                                            <img src="{{ RvMedia::getImageUrl($featureCompany->logo_thumb) }}" alt="{{ $featureCompany->name }}">
                                        </a>
                                    </div>
                                @endforeach
                            </div>
