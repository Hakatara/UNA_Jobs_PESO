...
<div class="form-group">
    ...
    <input name="job_categories" data-list="{{ $categories }}" class="form-control list-tagify" value="{{ Arr::get($attributes, 'job_categories') }}" placeholder="{{ __('Select categories from the list') }}">
</div>
